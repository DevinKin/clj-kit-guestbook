(ns devin.guestbook.web.routes.pages
  (:require
   [devin.guestbook.web.controllers.guestbook :as guestbook]
   [devin.guestbook.web.middleware.exception :as exception]
   [devin.guestbook.web.pages.layout :as layout]
   [devin.guestbook.web.routes.utils :as utils]
